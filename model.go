...
func (AccessM AccessModel) GetContentAccessList(limit, offset int, filter Filter, DB *gorm.DB, tenantid string) (contentAccessList []Tblaccesscontrol, count int64, err error) {
...
func (AccessModel) GetAccessGrantedMemberGroups(memberGroups *[]TblAccessControlUserGroup, accessId int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetMemberGroupsByContentAccessMemId(memgrp *member.TblMemberGroup, id int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetaccessGrantedPageCount(count *int64, accessId int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetaccessGrantedEntriesCount(count *int64, accessId int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetContentAccessByAccessId(id int, DB *gorm.DB, tenantid string) (accesscontrol *Tblaccesscontrol, err error) {
...
// func (AccessModel) GetPagesAndPageGroupsInContentAccess(accessId int, DB *gorm.DB, tenantid string) (contentAccessPages []Tblaccesscontrolpages, err error) {
...
// func (AccessModel) GetPageGroupsInContentAccess(accessId int, DB *gorm.DB, tenantid string) (contentAccessPages []Tblaccesscontrolpages, err error) {

// 	query := DB.Model(TblAccessControlPages{}).Debug().Select("tbl_access_control_pages.page_group_id,tbl_access_control_pages.id").Where("tbl_access_controls.id = ? and  tbl_access_controls.tenant_id=?", accessId, tenantid)
...
// func (AccessModel) GetSelectedSpaces(accessId int, DB *gorm.DB, tenantid string) (contentAccessPages []Tblaccesscontrolpages, err error) {
...
// 	query.Debug().Find(&contentAccessPages)
...
func (AccessModel) GetSelectedEntries(accessId int, DB *gorm.DB, tenantid string) (contentAccessPages []Tblaccesscontrolpages, err error) {
...
func (AccessModel) DeletePage(pg_access *TblAccessControlPages, id []int, pgids []int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) DeleteGroup(pg_access *TblAccessControlPages, id []int, grpid []int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) DeleteSubPage(pg_access *TblAccessControlPages, id []int, spacesid []int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetGroupsByAccessId(accessid int, DB *gorm.DB, tenantid string) (usergroups []TblAccessControlUserGroup, er error) {
...
func (AccessModel) UpdateContentAccessId(contentAccess *TblAccessControl, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) DeleteControlAccess(accesscontrol *TblAccessControl, id int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetAccessGrantedMemberGroupsList(memgrps *[]int, accessId int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetAccessGrantedEntries(AccessEntries *[]TblAccessControlPages, accessId int, DB *gorm.DB, tenantid string) error {

	if err := DB.Table("tbl_access_control_pages").Debug().Select("distinct on (tbl_access_control_pages.entry_id) tbl_access_control_pages.*").
...
func (AccessModel) GetEntriesCountUnderChannel(count *int64, channelId int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) CheckPresenceOfAccessGrantedMemberGroups(count *int64, mem_id, accessId int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GrantAccessToMemberGroups(memberGrpAccess *TblAccessControlUserGroup, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) UpdateContentAccessMemberGroup(accessmemgrp *TblAccessControlUserGroup, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetMemberGrpByAccessControlId(memberGrpAccess *[]TblAccessControlUserGroup, content_access_id int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) CheckPresenceOfChannelEntriesInContentAccess(count *int64, accessGroupId, chanId, entryId int, DB *gorm.DB, tenantid string) error {

	if err := DB.Table("tbl_access_control_pages").Debug().Where("is_deleted = 0 and access_control_user_group_id = ? and channel_id = ? and entry_id = ? and  tenant_id=?", accessGroupId, chanId, entryId, tenantid).Count(count).Error; err != nil {
...
// update accesspage
func (AccessModel) UpdateAccessPage(chanAccess *TblAccessControlPages, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) RemoveChannelEntriesNotUnderContentAccess(chanAccess *TblAccessControlPages, entryIds []int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) DeleteInAccessUserGroup(accessusergrp *TblAccessControlUserGroup, Id int, DB *gorm.DB, tenantid string) error {
...
func (AccessModel) GetDeleteIdInAccessUserGroup(controlaccessgrp *[]TblAccessControlUserGroup, Id int, DB *gorm.DB, tenantid string) (*[]TblAccessControlUserGroup, error) {
...
func (AccessModel) DeleteAccessControlPages(pg_access *TblAccessControlPages, Id []int, DB *gorm.DB, tenantid string) error {
