...
func (AccessM AccessModel) GetContentAccessList(limit, offset int, filter Filter, DB *gorm.DB, tenantid int) (contentAccessList []Tblaccesscontrol, count int64, err error) {
	...
	query := DB.Table("tbl_access_controls").Select("tbl_access_controls.*,tbl_users.username,tbl_roles.name").Where("tbl_access_controls.is_deleted = 0 and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)",tenantid).Order("tbl_access_controls.id DESC")
...
func (AccessModel) GetAccessGrantedMemberGroups(memberGroups *[]TblAccessControlUserGroup, accessId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_user_groups").Where("is_deleted = 0 and access_control_id = ? and (tenant_id is NULL or tenant_id=?)", accessId,tenantid).Find(&memberGroups).Error; err != nil {
...
func (AccessModel) GetMemberGroupsByContentAccessMemId(memgrp *member.TblMemberGroup, id int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_member_groups").Where("is_deleted = 0 and id = ? and (tenant_id is NULL or tenant_id=?)", id,tenantid).First(&memgrp).Error; err != nil {
...
func (AccessModel) GetaccessGrantedPageCount(count *int64, accessId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_controls").Distinct("tbl_access_control_pages.page_id").Joins("inner join tbl_access_control_user_groups on tbl_access_control_user_groups.access_control_id = tbl_access_controls.id").
		...
		Where("tbl_access_controls.is_deleted = 0 and tbl_access_control_pages.is_deleted = 0 and tbl_access_controls.id = ? and tbl_access_control_pages.page_id!= 0 and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)", accessId,tenantid).Count(count).Error; err != nil {
...
func (AccessModel) GetaccessGrantedEntriesCount(count *int64, accessId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_controls").Distinct("tbl_access_control_pages.entry_id").Joins("inner join tbl_access_control_user_groups on tbl_access_control_user_groups.access_control_id = tbl_access_controls.id").
		Joins("inner join tbl_access_control_pages on tbl_access_control_pages.access_control_user_group_id = tbl_access_control_user_groups.id").
		Where("tbl_access_controls.is_deleted = 0 and tbl_access_control_pages.is_deleted = 0 and tbl_access_controls.id = ? and tbl_access_control_pages.entry_id!= 0 and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)", accessId,tenantid).Count(count).Error; err != nil {
...
func (AccessModel) GetContentAccessByAccessId(id int, DB *gorm.DB,tenantid int) (accesscontrol *Tblaccesscontrol, err error) {
	...
	if err := DB.Table("tbl_access_controls").Where("is_deleted = 0 and id = ? and (tenant_id is NULL or tenant_id=?)", id,tenantid).First(&accesscontrol).Error; err != nil {
...
func (AccessModel) GetPagesAndPageGroupsInContentAccess(accessId int, DB *gorm.DB,tenantid int) (contentAccessPages []Tblaccesscontrolpages, err error) {
	...
	query := DB.Model(TblAccessControlPages{}).Select("tbl_access_control_pages.*,tbl_pages.parent_id").Where("tbl_access_controls.id = ? and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)", accessId,tenantid)
...
func (AccessModel) GetPageGroupsInContentAccess(accessId int, DB *gorm.DB,tenantid int) (contentAccessPages []Tblaccesscontrolpages, err error) {
	...
	query := DB.Model(TblAccessControlPages{}).Select("tbl_access_control_pages.page_group_id,tbl_access_control_pages.id").Where("tbl_access_controls.id = ? and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)", accessId,tenantid)
...
func (AccessModel) GetSelectedSpaces(accessId int, DB *gorm.DB,tenantid int) (contentAccessPages []Tblaccesscontrolpages, err error) {
	...
	query := DB.Model(TblAccessControlPages{}).Select("spaces_id").Where("tbl_access_controls.id = ? and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)", accessId,tenantid)
...
func (AccessModel) GetSelectedEntries(accessId int, DB *gorm.DB,tenantid int) (contentAccessPages []Tblaccesscontrolpages, err error) {
	...
	query := DB.Model(TblAccessControlPages{}).Where("tbl_access_controls.id = ? and (tbl_access_controls.tenant_id is NULL or tbl_access_controls.tenant_id=?)", accessId,tenantid)
...
func (AccessModel) DeletePage(pg_access *TblAccessControlPages, id []int, pgids []int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Model(TblAccessControlPages{}).Where("access_control_user_group_id in (?) and page_id in (?) and (tenant_id is NULL or tenant_id=?)", id, pgids,tenantid).UpdateColumns(map[string]interface{}{"is_deleted": pg_access.IsDeleted, "deleted_on": pg_access.DeletedOn, "deleted_by": pg_access.DeletedBy}).Error; err != nil {
...
func (AccessModel) DeleteGroup(pg_access *TblAccessControlPages, id []int, grpid []int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Model(TblAccessControlPages{}).Where("access_control_user_group_id in (?) and page_group_id in (?) and (tenant_id is NULL or tenant_id=?)", id, grpid,tenantid).UpdateColumns(map[string]interface{}{"is_deleted": pg_access.IsDeleted, "deleted_on": pg_access.DeletedOn, "deleted_by": pg_access.DeletedBy}).Error; err != nil {
...
func (AccessModel) DeleteSubPage(pg_access *TblAccessControlPages, id []int, spacesid []int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Model(TblAccessControlPages{}).Where("access_control_user_group_id in (?) and spaces_id in (?) and (tenant_id is NULL or tenant_id=?)", id, spacesid,tenantid).UpdateColumns(map[string]interface{}{"is_deleted": pg_access.IsDeleted, "deleted_on": pg_access.DeletedOn, "deleted_by": pg_access.DeletedBy}).Error; err != nil {
...
func (AccessModel) GetGroupsByAccessId(accessid int, DB *gorm.DB,tenantid int) (usergroups []TblAccessControlUserGroup, er error) {
	...
	if err := DB.Model(TblAccessControlUserGroup{}).Where("access_control_id=? and (tenant_id is NULL or tenant_id=?)", accessid,tenantid).Find(usergroups).Error; err != nil {
...
func (AccessModel) UpdateContentAccessId(contentAccess *TblAccessControl, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_controls").Where("is_deleted = 0 and id = ? and (tenant_id is NULL or tenant_id=?)", contentAccess.Id,tenantid).UpdateColumns(map[string]interface{}{"access_control_name": contentAccess.AccessControlName, "access_control_slug": contentAccess.AccessControlSlug, "modified_on": contentAccess.ModifiedOn, "modified_by": contentAccess.ModifiedBy}).Error; err != nil {
...
func (AccessModel) DeleteControlAccess(accesscontrol *TblAccessControl, id int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_controls").Where("id = ? and (tenant_id is NULL or tenant_id=?)", id,tenantid).UpdateColumns(map[string]interface{}{"deleted_by": accesscontrol.DeletedBy, "deleted_on": accesscontrol.DeletedOn, "is_deleted": accesscontrol.IsDeleted}).Error; err != nil {
...
func (AccessModel) GetAccessGrantedMemberGroupsList(memgrps *[]int, accessId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_member_groups").Select("tbl_member_groups.id").
		...
		Where("tbl_member_groups.is_deleted = 0 and tbl_access_control_user_groups.access_control_id = ? and (tbl_member_groups.tenant_id is NULL or tbl_member_groups.tenant_id=?)", accessId,tenantid).Find(&memgrps).Error; err != nil {
...
func (AccessModel) GetAccessGrantedEntries(AccessEntries *[]TblAccessControlPages, accessId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_pages").Select("distinct on (tbl_access_control_pages.entry_id),(tbl_access_control_pages.*").
		...
		Where("tbl_access_controls.is_deleted = 0 and tbl_access_control_pages.is_deleted = 0 and tbl_access_controls.id = ? and tbl_access_control_pages.entry_id!= 0 and (tbl_access_control_pages.tenant_id is NULL or tbl_access_control_pages.tenant_id=?)", accessId,tenantid).Find(&AccessEntries).Error; err != nil {
...
func (AccessModel) GetEntriesCountUnderChannel(count *int64, channelId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_channel_entries").Where("is_deleted = 0 and status = 1 and channel_id = ? and (tenant_id is NULL or tenant_id=?)", channelId,tenantid).Count(count).Error; err != nil {
...
func (AccessModel) CheckPresenceOfAccessGrantedMemberGroups(count *int64, mem_id, accessId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_user_groups").Where("is_deleted = 0 and member_group_id = ? and access_control_id = ? and (tenant_id is NULL or tenant_id=?)", mem_id, accessId,tenantid).Count(count).Error; err != nil {
...
func (AccessModel) UpdateContentAccessMemberGroup(accessmemgrp *TblAccessControlUserGroup, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_user_groups").Where("is_deleted = 0 and access_control_id = ? and member_group_id = ? and (tenant_id is NULL or tenant_id=?)", accessmemgrp.AccessControlId, accessmemgrp.MemberGroupId,tenantid).UpdateColumns(map[string]interface{}{"modified_on": accessmemgrp.ModifiedOn, "modified_by": accessmemgrp.ModifiedBy}).Error; err != nil {
...
func (AccessModel) GetMemberGrpByAccessControlId(memberGrpAccess *[]TblAccessControlUserGroup, content_access_id int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_user_groups").Where("is_deleted = 0 and access_control_id = ? and (tenant_id is NULL or tenant_id=?)", content_access_id,tenantid).Find(&memberGrpAccess).Error; err != nil {
...
func (AccessModel) CheckPresenceOfChannelEntriesInContentAccess(count *int64, accessGroupId, chanId, entryId int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_pages").Where("is_deleted = 0 and access_control_user_group_id = ? and channel_id = ? and entry_id = ? and (tenant_id is NULL or tenant_id=?)", accessGroupId, chanId, entryId,tenantid).Count(count).Error; err != nil {
...
func (AccessModel) UpdateAccessPage(chanAccess *TblAccessControlPages, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_pages").Where("is_deleted = 0 and access_control_user_group_id = ? and channel_id = ? and entry_id = ? and (tenant_id is NULL or tenant_id=?)", chanAccess.AccessControlUserGroupId, chanAccess.ChannelId, chanAccess.EntryId,tenantid).UpdateColumns(map[string]interface{}{"modified_on": chanAccess.ModifiedOn, "modified_by": chanAccess.ModifiedBy}).Error; err != nil {
...
func (AccessModel) RemoveChannelEntriesNotUnderContentAccess(chanAccess *TblAccessControlPages, entryIds []int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Debug().Table("tbl_access_control_pages").Where("is_deleted = 0 and access_control_user_group_id = ? and entry_id != 0 and entry_id NOT IN (?) and (tenant_id is NULL or tenant_id=?)", chanAccess.AccessControlUserGroupId, entryIds,tenantid).UpdateColumns(map[string]interface{}{"is_deleted": chanAccess.IsDeleted, "deleted_on": chanAccess.DeletedOn, "deleted_by": chanAccess.DeletedBy}).Error; err != nil {
...
func (AccessModel) DeleteInAccessUserGroup(accessusergrp *TblAccessControlUserGroup, Id int, DB *gorm.DB,tenantid int) error {
	...
	if err := DB.Table("tbl_access_control_user_groups").Where("access_control_id = ? and (tenant_id is NULL or tenant_id=?)", Id,tenantid).UpdateColumns(map[string]interface{}{"deleted_by": accessusergrp.DeletedBy, "deleted_on": accessusergrp.DeletedOn, "is_deleted": accessusergrp.IsDeleted}).Error; err != nil {
...
func (AccessModel) GetDeleteIdInAccessUserGroup(controlaccessgrp *[]TblAccessControlUserGroup, Id int, DB *gorm.DB,tenantid int) (*[]TblAccessControlUserGroup, error) {
	...
	if err := DB.Table("tbl_access_control_user_groups").Where("access_control_id = ? and (tenant_id is NULL or tenant_id=?)", Id,tenantid).Find(&controlaccessgrp).Error; err != nil {
...
func (AccessModel) DeleteAccessControlPages(pg_access *TblAccessControlPages, Id []int, DB *gorm.DB,tenantid int) error {
	if err := DB.Table("tbl_access_control_pages").Where("access_control_user_group_id IN ? and (tenant_id is NULL or tenant_id=?)", Id,tenantid).UpdateColumns(map[string]interface{}{"deleted_by": pg_access.DeletedBy, "deleted_on": pg_access.DeletedOn, "is_deleted": pg_access.IsDeleted}).Error; err != nil {
